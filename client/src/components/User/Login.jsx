...
export default function Login(props){
    ...
    <div className="bg-primary w-full overflow-hidden">
        <div class="flex min-h-full flex-col justify-center px-18 py-24 lg:px-8">
        ...
        <form className="space-y-6" action="#" method="POST">
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Not a member?{' '}
            <a onClick={onRegisterClick} className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 cursor-pointer">
              Create your account
            </a>
          </p>
        </div>
